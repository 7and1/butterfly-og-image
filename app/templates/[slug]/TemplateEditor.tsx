...
import { TemplateInputs, hasTemplateInputs } from "@/components/editor/TemplateInputs";
...
export default function TemplateEditor({ slug }: TemplateEditorProps) {
  ...
  const templateContent = getTemplateContent(slug as TemplateId);
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            {/* Advanced Options - Template Specific Inputs */}
            {hasTemplateInputs(slug as TemplateId) && (
              <Card className="p-4">
                <details className="group" open>
                  <summary className="flex items-center justify-between cursor-pointer text-lg font-semibold text-white mb-4 list-none">
        ...
        <div className="mt-16 border-t border-neutral-800 pt-12">
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">
                Best Use Cases for {template.name} Template
              </h2>
              <p className="text-neutral-400 mb-6">
                {templateContent.subheading}
              </p>
              <ul className="space-y-3">
                {templateContent.useCases.map((useCase, index) => (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {templateContent.bestFor.map((item, index) => (
                  <span
                    key={index}
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-bold text-white mb-6">
              Pro Tips for Creating Great {template.name} OG Images
            </h2>
            <div className="grid gap-4 sm:grid-cols-2">
              {templateContent.tips.map((tip, index) => (
                <Card key={index} className="p-4">
                  <div className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-8 h-8 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center text-sm font-bold">
                      {index + 1}
                    </span>
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-bold text-white mb-6">
              Example Titles to Get You Started
            </h2>
            <div className="space-y-4">
              {templateContent.exampleTitles.map((title, index) => (
                <button
                  key={index}
                  onClick={() => {
                    setContent({
                      title,
                      description: templateContent.exampleDescriptions[index] || ""
                    });
                    toast.success("Example applied!");
                  }}
                  className="w-full text-left p-4 bg-neutral-800/50 hover:bg-neutral-800 rounded-lg transition-colors border border-neutral-700 hover:border-neutral-600"
                >
                  <p className="text-white font-medium">{title}</p>
                  <p className="text-neutral-400 text-sm mt-1">
                    {templateContent.exampleDescriptions[index]}
                  </p>
                </button>
              ))}
            </div>
          ...
          <div className="mt-12">
            ...
            <div className="space-y-4">
              <details className="group bg-neutral-800/50 rounded-lg border border-neutral-700">
                ...
                <div className="px-4 pb-4 text-neutral-400">
                  Open Graph images are preview images that appear when you share a link on social media platforms like Facebook, Twitter, LinkedIn, and Discord. They help make your shared links more visually appealing and increase click-through rates.
                </div>
              </details>
              ...
              <details className="group bg-neutral-800/50 rounded-lg border border-neutral-700">
                ...
                <div className="px-4 pb-4 text-neutral-400">
                  The recommended size for Open Graph images is 1200x630 pixels. This aspect ratio (1.91:1) works well across most social media platforms and ensures your image displays correctly without being cropped.
                </div>
              </details>

              <details className="group bg-neutral-800/50 rounded-lg border border-neutral-700">
                <summary className="flex items-center justify-between p-4 cursor-pointer text-white font-medium">
                  How do I add this image to my website?
                  <svg className="w-5 h-5 text-neutral-400 group-open:rotate-180 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </summary>
                <div className="px-4 pb-4 text-neutral-400">
                  Download your OG image and host it on your website. Then add meta tags to your HTML head: <code className="bg-neutral-900 px-2 py-0.5 rounded text-sm">&lt;meta property=&quot;og:image&quot; content=&quot;your-image-url&quot; /&gt;</code>. For Next.js, you can use the metadata API.
                </div>
              </details>
              ...
              <details className="group bg-neutral-800/50 rounded-lg border border-neutral-700">
                ...
                <div className="px-4 pb-4 text-neutral-400">
                  Yes! og-image.org is completely free to use. No signup required, no watermarks, and unlimited downloads. All processing happens in your browser for maximum privacy.
                </div>
              </details>
            </div>
          </div>
